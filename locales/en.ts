const en: { [key: string]: string } = {
  ...
  toys: "toys",
  outros: "Outros",
  alimentoUmido: "Alimento Úmido",
  petiscosNaturais: "Petiscos Naturais",
  comedouros: "Comedouros",
  tapetesParaAlimentacao: "Tapetes para Alimentação",
  brinquedosEMordedores: "Brinquedos e Mordedores",
  pelucias: "Pelúcias",
  kongs: "Kongs",
  cosmetic: "Cosmetic",
  ...
  semProdutos: "Sem produtos ainda nesta categoria.",
